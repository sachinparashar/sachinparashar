...
<div class="content">
	...
	<form class="login-form" action="" method="post">
		...
		<div class="form-group">
			...
			<input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Email or Phone" name="email" id="email"/>
		...
		<div class="form-actions">
			<button type="button" class="btn btn-md green uppercase login_btn">Login</button>
			<button type="button" class="btn btn-md blue uppercase signup_btn">Signup</button>
