										...
										<div class="row">
											...
											<div class="col-md-12 ">
												...
												<div class="col-md-12">
													...
													<div class="col-md-4 ">
															<button type="button" class="btn btn-md blue uppercase "><?= $article['likes']?>&nbsp;Liked</button>
													</div>
													<div class="col-md-4 ">
															<button type="button" class="btn btn-md blue uppercase"><?= $article['dislikes']?>&nbsp;Disliked</button>
													</div>
													<div class="col-md-4 ">
														<button type="button" class="btn btn-md blue uppercase block_btn" data-id="<?= $article['id']; ?>"><?= $article['blocks']?>&nbsp;Blocked</button>
													</div>
													<div>
