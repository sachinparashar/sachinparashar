...
(function($) {
  ...
  $.fn.simpleCropper = function() {
        ...
        $('.form_with_image').append(bottom_html);
        var image_dimension_x = 600;
        var image_dimension_y = 600;
        var scaled_width = 0;
        var scaled_height = 0;
    ...
    var ias = null;
    var jcrop_api;
    var bottom_html = "<input type='file' id='fileInput' name='file_image'/><canvas id='myCanvas' style='display:none;'></canvas><div id='modal'></div><div id='preview'><div class='buttons'><div class='cancel'></div><div class='ok'></div></div></div>";
    $('.form_with_image').append(bottom_html);
